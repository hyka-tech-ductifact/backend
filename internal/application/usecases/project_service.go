...
type ProjectService interface {
	...
	GetProjectByID(ctx context.Context, id uuid.UUID, clientID uuid.UUID, userID uuid.UUID) (*entities.Project, error)
	...
	UpdateProject(ctx context.Context, id uuid.UUID, clientID uuid.UUID, userID uuid.UUID, params entities.UpdateProjectParams) (*entities.Project, error)
	DeleteProject(ctx context.Context, id uuid.UUID, clientID uuid.UUID, userID uuid.UUID) error
}
