...
func SetupRoutes(
	...
	helpers.RegisterDomainError(services.ErrClientNotOwned, http.StatusNotFound, "client not found")
	helpers.RegisterDomainError(services.ErrProjectNotFound, http.StatusNotFound, "project not found")
	helpers.RegisterDomainError(services.ErrProjectNotOwned, http.StatusNotFound, "project not found")
	...
	helpers.RegisterDomainError(services.ErrOrderNotOwned, http.StatusNotFound, "order not found")
	...
	helpers.RegisterDomainError(services.ErrPieceDefNotOwned, http.StatusNotFound, "piece definition not found")
	helpers.RegisterDomainError(services.ErrPieceNotFound, http.StatusNotFound, "piece not found")
	helpers.RegisterDomainError(services.ErrPieceNotOwned, http.StatusNotFound, "piece not found")
