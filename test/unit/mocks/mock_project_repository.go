...
type MockProjectRepository struct {
	...
	ListByClientIDFn  func(ctx context.Context, clientID uuid.UUID, opts query.ProjectListQuery) ([]*entities.Project, int64, error)
...
func (m *MockProjectRepository) ListByClientID(
	...
	if m.ListByClientIDFn != nil {
		return m.ListByClientIDFn(ctx, clientID, opts)
	}
	return nil, 0, nil
}
